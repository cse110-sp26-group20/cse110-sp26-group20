                ...
                .then(data => {
                    ...
                    .then(aiData => {
                        ...
                        resultImg.onload = () => {
                            ...
                            context.drawImage(resultImg, 0, 0, canvas.width, canvas.height);
                        };

                        //check if error occurred during new image processing
                        resultImg.onerror = () => {
                            console.error('Failed to load generated image from URL:', aiData.url);
                        };
